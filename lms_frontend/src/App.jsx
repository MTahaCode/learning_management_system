  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/teacherAssignmentManagement" element={<TeacherAssignmentManagement />} />
        ...
        <Route path="/teacherAnnouncements" element={<AnnouncementManagement loginCredentials={loginCredentials}/>} />
